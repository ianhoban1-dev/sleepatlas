...
export const SITE = {
  ...
  description:
    "SLEYP builds a personal soundscape around the room you actually sleep in. Thirteen layered sounds generated live in your browser, a sleep timer that fades rather than stops, and tools built on forty years of shift work.",
  locale: "en_GB",
} as const;

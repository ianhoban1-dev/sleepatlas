    ...
    blocks: [
      ...
      },
      {
        ...
        items: [
          ...
          "Sound floor second. The world is loud at 9am — bins, school runs, deliveries. A brown-noise bed from a machine or the Mask AI player raises the background floor so a slammed car door stops registering as an alert.",
